...
open_id = 'oOpUI0a1br1qnjij1HpgdHEtnWLA'
page_index = 0
page_size = 20
req_time = str(int(round(time.time() * 1000)))
sort_type = 0
user_token = 'mQcW_Cq8AAMnnzVw0-oLXgxNKAYAAAAAswkAAPPi_IlNZrjzfXZlxGRBLqAugdUymEu4zPFEaRQFMGyxXKYLC8fhO6xUliu4frBlGQ'
user_id = '643826582'
uuid = '1043401306540314714'
lat = '29561864'
lon =  '106554449'
platform = 'ios'
dtype =  'iPhone 8 Plus (GSM+CDMA)<iPhone10,2>'
...
# 获取数据
store_page_url = "https://wx.waimai.meituan.com/weapp/v2/poi/homepage?ui=1807785726&region_id=1000130300&region_version=1580907712941"

store_data = requests.post(url=store_page_url,headers=headers,data=data,verify=False).json()

print(store_data)
# print(store_data["data"]["poilist"][1]["name"])
# print(store_data["data"]["poilist"][2]["name"])
# print(store_data["data"]["poilist"][3]["name"])